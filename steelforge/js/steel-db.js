(() => {
  ...
  window.SteelForgeStructuralSteelGrades = [
    ...
    { catalogId: 2, id: 'a53_b', label: 'A53 Gr. B', fy: 35, fu: 60 },
    { catalogId: 3, id: 'a500_b', label: 'A500 Gr. B', fy: 42, fu: 58 },
    { catalogId: 4, id: 'a500_c', label: 'A500 Gr. C', fy: 46, fu: 62 },
    { catalogId: 5, id: 'a501_36', label: 'A501 (Fy = 36 ksi)', fy: 36, fu: 58 },
    { catalogId: 6, id: 'a514', label: 'A514', fy: 100, fu: 110 },
    { catalogId: 7, id: 'a529_50_fu70', label: 'A529 Gr. 50', fy: 50, fu: 70 },
    { catalogId: 8, id: 'a529_55', label: 'A529 Gr. 55', fy: 55, fu: 70 },
    { catalogId: 9, id: 'a572_42', label: 'A572 Gr. 42', fy: 42, fu: 60 },
    { catalogId: 10, id: 'a572_50', label: 'A572 Gr. 50', fy: 50, fu: 65 },
    { catalogId: 11, id: 'a572_55', label: 'A572 Gr. 55', fy: 55, fu: 70 },
    { catalogId: 12, id: 'a572_60', label: 'A572 Gr. 60', fy: 60, fu: 75 },
    { catalogId: 13, id: 'a572_65', label: 'A572 Gr. 65', fy: 65, fu: 80 },
    { catalogId: 14, id: 'a588', label: 'A588', fy: 50, fu: 70 },
    ...
    { catalogId: 20, id: 'a709_36', label: 'A709 Gr. 36', fy: 36, fu: 58 },
    { catalogId: 21, id: 'a709_50', label: 'A709 Gr. 50', fy: 50, fu: 65 },
    { catalogId: 22, id: 'a709_50w', label: 'A709 Gr. 50W', fy: 50, fu: 70 },
    ...
    { catalogId: 26, id: 'a847', label: 'A847', fy: 50, fu: 70 },
    { catalogId: 27, id: 'a852', label: 'A852', fy: 70, fu: 90 },
    { catalogId: 28, id: 'a913_50', label: 'A913 Gr. 50', fy: 50, fu: 65 },
    { catalogId: 29, id: 'a913_60', label: 'A913 Gr. 60', fy: 60, fu: 75 },
    { catalogId: 30, id: 'a913_65', label: 'A913 Gr. 65', fy: 65, fu: 80 },
    { catalogId: 31, id: 'a913_70', label: 'A913 Gr. 70', fy: 70, fu: 90 },
    { catalogId: 32, id: 'a992', label: 'A992', fy: 50, fu: 65 },
    // Additional rows from client table / supplemental sheet
    { id: 'a501_gr_a', label: 'A501 Gr. A', fy: 36, fu: 58 },
    { id: 'a501_gr_b', label: 'A501 Gr. B', fy: 50, fu: 70 },
    { id: 'a529_50_fu65', label: 'A529 Gr. 50 (Fu = 65 ksi)', fy: 50, fu: 65 },
    { id: 'a618_gr12', label: 'A618 Gr. I & II', fy: 50, fu: 70 },
    { id: 'a618_gr3', label: 'A618 Gr. III', fy: 50, fu: 65 },
    { id: 'a709_50s', label: 'A709 Gr. 50S', fy: 50, fu: 65 },
    { id: 'a1043_36', label: 'A1043 Gr. 36', fy: 36, fu: 58 },
    { id: 'a1043_50', label: 'A1043 Gr. 50', fy: 50, fu: 65 },
    { id: 'a1085_a', label: 'A1085 Gr. A', fy: 50, fu: 65 },
    { id: 'a1065_50_fu60', label: 'A1065 Gr. 50 (Fu = 60 ksi)', fy: 50, fu: 60 },
    { id: 'a1065_50_fu70', label: 'A1065 Gr. 50 (Fu = 70 ksi)', fy: 50, fu: 70 },
  ];
